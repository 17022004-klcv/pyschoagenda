...
export const ConsentPdfDocument = ({ patient }: ConsentPdfProps) => {
  ...
  return (
    <Document title={`Consentimiento_${patient.name.replace(/\s+/g, "_")}`}>
      <PdfLayout
      ...
      >
        ...
        <View style={styles.boxSection}>
          <Text style={styles.paragraph}>
            ...
            {"\n"}
            Yo, <Text style={styles.bold}>{declarantName}</Text>,
            identificado(a) con documento de identidad / DUI N°{" "}
            ...
            (Edad: <Text style={styles.bold}>{patient.age} años</Text>), otorgo
            de manera libre y voluntaria el presente consentimiento.
          </Text>
        </View>
        ...
        <View style={styles.boxSection}>
          ...
          <View style={styles.bulletList}>
            <Text style={styles.bulletItem}>
              ...
              situaciones donde exista riesgo inminente para la vida de la
              persona o terceros.
            </Text>
            <Text style={styles.bulletItem}>
