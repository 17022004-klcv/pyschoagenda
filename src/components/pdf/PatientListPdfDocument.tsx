...
export const PatientListPdfDocument = ({
  ...
  <Document title="Reporte_General_de_Pacientes">
    <PdfLayout
    ...
    >
      <View style={styles.filterBadge}>
        <Text>
          ...
          registros:{" "}
          <Text style={{ fontWeight: "bold" }}>{patients.length}</Text>
        </Text>
      </View>
      ...
      <View style={styles.table}>
        ...
        {patients.length === 0 ? (
          ...
          patients.map((p, index) => (
            <View style={styles.tableRow} key={p.id || `patient-${index}`}>
              <View style={styles.colName}>
